...
export const erroringProjectFixture: Project = {
  block: null,
  id: 26,
  name: "Refraction",
  ciProvider: "Circleci",
  criticality: 3,
  description: "Auction projections",
  tags: ["platform"],
  orbs: ["hokusai", "yarn"],
  dependencies: [],
  dependenciesUpToDate: true,
  ...
  gitRemote: "https://github.com/artsy/refraction.git",
  isAutoDeploy: true,
  isFullyReleased: true,
  isKubernetes: true,
  maintenanceMessages: [],
  ...
  severity: 0,
  errorMessage: "No such file or directory @ dir_chdir - refraction",
}
